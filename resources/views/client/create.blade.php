            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="w-full lg:w-2/3 space-y-2">
                    ...
                    <div>
                        ...
                        <input class="block form-input @error('client.name') is-invalid @enderror w-full max-w-md" id="client['name']" type="text" name="client[name]" value="{{ old('client.name') }}" />
                        @error('client.name')
                            <x-error :message="$message" />
                        @enderror
                    </div>
                    <div>
                        ...
                        <input class="block form-input @error('client.address') is-invalid @enderror w-full max-w-md" id="client['address']" type="text" name="client[address]" value="{{ old('client.address') }}" />
                    ...
                    <div>
                        ...
                        <input class="block form-input @error('client.phone') is-invalid @enderror w-full max-w-xs" id="client['phone']" type="text" name="client[phone]" value="{{ old('client.phone') }}" autocomplete="tel-national" />
                        @error('client.phone')
                            <x-error :message="$message" />
                        @enderror
                    </div>
                    <div>
                        ...
                        <input class="block form-input @error('client.email') is-invalid @enderror w-full max-w-sm" id="client['email']" type="text" name="client[email]" value="{{ old('client.email') }}" />
                        @error('client.email')
                            <x-error :message="$message" />
                        @enderror
                    </div>
