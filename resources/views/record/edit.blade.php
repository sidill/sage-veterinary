            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="w-full lg:w-2/3 space-y-2">
                    ...
                    <div>
                        ...
                        <input class="block form-input @error('client.phone') is-invalid @enderror w-full max-w-xs" id="client['phone']" type="text" name="client[phone]" value="{{ $record->patient->client->phone }}" readonly />
                        @error('client.phone')
                            <x-error :message="$message" />
                        @enderror
                    </div>
